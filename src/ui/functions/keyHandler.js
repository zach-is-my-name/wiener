...
//export function keyHandler(mainBoxRef, scrollToScrollHeightFlagRef, scrollToZeroFlagRef, dispatch) { 
  export async function keyHandler(e, ch, key, mainBoxRef, scrollToScrollHeightFlagRef, scrollToZeroFlagRef, dispatch ) {
    console.log("e", e)
