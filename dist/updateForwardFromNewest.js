...
export function updateForwardFromNewest() {
  return _updateForwardFromNewest.apply(this, arguments);
}

function _updateForwardFromNewest() {
  _updateForwardFromNewest = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3() {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            console.log("".concat(chalk.yellow('Getting Forward from Latest')));
            storedNewsletters = fs.readdirSync('./archive/markdownNewsletters/freshTest').sort(function (a, b) {
              return new Date(b) - new Date(a);
            });

            if (storedNewsletters.length) {
              urlNewestInArchive = getUrlOfNewsletter(getNewsletterFromDate(storedNewsletters.slice().shift()));
