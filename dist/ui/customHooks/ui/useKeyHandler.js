          ...
          case 0:
            updateCoordinate = function _updateCoordinate(input) {
              if (input === 'j' || input === 'k') {
                ...
                dispatch({
                  type: "setCursorTop",
                  payload: nextCursorPosition(cursorTop, input === 'j', mainBoxRef === null || mainBoxRef === void 0 ? void 0 : (_mainBoxRef$current = mainBoxRef.current) === null || _mainBoxRef$current === void 0 ? void 0 : _mainBoxRef$current.getScrollHeight(), 1)
                });
                ...
                dispatch({
                  type: "setCursorLeft",
                  payload: nextCursorPosition(cursorLeft, input === 'l', (_mainBoxRef$current3 = mainBoxRef.current) === null || _mainBoxRef$current3 === void 0 ? void 0 : _mainBoxRef$current3.width, 3)
                });
